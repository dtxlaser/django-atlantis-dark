...
## Run into Dokploy
### Update 2 Files "config/settings.py" & "Dockerfile" Allow Access All to Port 8000
### Dockerfile hardcode 
**Command for Access All to Port 8000**
```bash
CMD ["gunicorn", "config.wsgi:application", "--bind", "0.0.0.0:8000"]
```
**Build Type**
-> Railpack
### OR Add External Command to Dokploy → Advanced → Start Command:
```bash
